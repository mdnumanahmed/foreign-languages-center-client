    ...
    <div className="h-28 sm:h-64 md:h-80 lg:h-96">
      <Carousel>
        <div className="relative flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          <img src={slide1} alt="" />
          <div className="absolute left-3 md:left-6 lg:left-[10%] space-y-4 bg-gray-600/10 backdrop-brightness-90 p-10">
            <h3 className="text-5xl font-bold">Online Summer School</h3>
        ...
        <img src={slide2} alt="" />
        <div className="absolute left-3 md:left-6 lg:left-[10%] space-y-4 bg-gray-600/10 backdrop-brightness-90 p-10 text-white">
            <h3 className="text-5xl font-bold">Summer Camp in Canada</h3>
        ...
        <img src={slide3} alt="" />
        <div className="absolute left-3 md:left-6 lg:left-[10%] space-y-4 bg-gray-600/10 backdrop-brightness-90 p-10 text-white">
            <h3 className="text-5xl font-bold">Award-Winning Course</h3>
